...
public class TourComplet5Test {
    ...
    @Before
    public void ini() {
        drone = new Drone(EnumOrientation.SOUTH);
        state = new TourComplet5();
        read = new ReadJSON("{\"men\": 12,\"budget\": 10000,\"contracts\": [{ \"amount\": 600, \"resource\": \"WOOD\" },{ \"amount\": 200, \"resource\": \"GLASS\" }],\"heading\": \"S\"}");
    }

    @Test
    public void executeTest(){
        assertEquals(state.execute(drone),"{ \"action\": \"heading\", \"parameters\": { \"direction\":\"W\" } }");
    }
